 ...
 * single-threaded; real impls are no-ops in libyurt_guest_compat
 ...
 *
 * Provided by libyurt_guest_compat (yurt_process.c → wraps
 ...
 * libyurt_guest_compat sees the prototypes — there's nothing
