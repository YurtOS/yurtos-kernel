...
// #92 event-loop primitive method IDs (reserved here in S0; per-primitive
// dispatch handlers land in S1..S4). Drift-guarded so a renumber in the
// toml without a matching update here fails this test.
