...
//! match exactly the cases in abi/conformance/c/signal-canary.c
...
// sigset_t from yurt's signal.h:
//   typedef unsigned char sigset_t;
// It's a single byte.
type SigsetT = u8;

// sigaction struct layout on wasm32-wasip1 matching yurt's signal.h:
//   struct sigaction {
