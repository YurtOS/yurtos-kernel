...
archive `libyurt_abi.a`. The same archive is also the link-time
...
BusyBox (see `test-fixtures/c-ports/busybox/`). This package validates compile/link
...
These headers are intentionally narrow. They describe the kernel ABI
